    ...
    var demo = function () {
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'Collaborator/GetCollaboratorData',
                    },
                },
                pageSize: 10,
                saveState: false,
            ...
            },
            {
                ...
                template: function (data) {
                    return '\<a href ="/Collaborator/Delete/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
