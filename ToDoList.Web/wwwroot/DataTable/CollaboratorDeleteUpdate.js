    ...
    var demo = function () {
        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            data: {
                ...
                source: {
                    read: {
                        url: 'Collaborator/GetAllDataUpdateDelete',
                    },
                },
                pageSize: 10,
                saveState: false,
            ...
            },
            {
                ...
                template: function (data) {
                    return '\<a href ="/Collaborator/DeleteUpdate/' + data.id + '" tname="#kt_datatable" class="Confirm btn btn-sm btn-clean btn-icon" title="Delete">\
